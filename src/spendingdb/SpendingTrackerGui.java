...
import spendingdb.ViewSpendingButtonHandler;
...
public class SpendingTrackerGui extends javax.swing.JFrame {
	private javax.swing.JButton jButton5;
	private ViewSpendingButtonHandler viewSpendingButtonHandler;
    ...
    private void initComponents() {
        ...
        jButton5.setText("View Spending");
        viewSpendingButtonHandler = new ViewSpendingButtonHandler();
        jButton5.addActionListener(viewSpendingButtonHandler);
		...
		jButton5.setText("View Spending");  // New button for "View Spending"
        ...
        jPanel1Layout.setHorizontalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.LEADING)
        		.addComponent(jPanel2, GroupLayout.DEFAULT_SIZE, 656, Short.MAX_VALUE)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					...
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(a, GroupLayout.PREFERRED_SIZE, 78, GroupLayout.PREFERRED_SIZE)
        					.addPreferredGap(ComponentPlacement.RELATED)
        					.addComponent(jLabel4))
        				.addGroup(jPanel1Layout.createSequentialGroup()
        					.addComponent(btnChart, GroupLayout.PREFERRED_SIZE, 86, GroupLayout.PREFERRED_SIZE)
        					.addGap(18)
        			...
        			.addGroup(jPanel1Layout.createParallelGroup(Alignment.LEADING, false)
        				...
        				.addComponent(category, GroupLayout.PREFERRED_SIZE, 123, GroupLayout.PREFERRED_SIZE))
        			.addPreferredGap(ComponentPlacement.UNRELATED)
        ...
        jPanel1Layout.linkSize(SwingConstants.VERTICAL, new Component[] {jLabel2, d, a});
 ...
 "insert into spendings (category,sdate,amount) values('"+
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
    	//viewSpendingButtonHandler.openViewSpendingWindow();
    	// Your code for jButton5ActionPerformed
    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(SpendingTrackerGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
